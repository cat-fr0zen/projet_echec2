<?php
/**
 * Fichier du projet. Role : participer au fonctionnement du site. Theme principal : GoogleReviewsService.
 */
 ...
 * - cache fichier optionnel; il peut etre desactive si besoin en local
 */
