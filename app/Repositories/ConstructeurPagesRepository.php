    ...
    public static function definitionsParDefaut(string $codePage): array
    {
        ...
        return [
            ...
            [
                ...
                'description_bloc' => "Le puzzle d'echecs de la semaine.",
                'ordre_affichage' => 2,
                'est_actif' => true,
                'est_verrouille' => true,
                'created_at' => $instant,
            ...
            [
                ...
                'description_bloc' => 'Le texte de presentation du club.',
                'ordre_affichage' => 3,
                'est_actif' => true,
            ...
            [
                ...
                'description_bloc' => 'Les liens rapides vers la federation et la ligue.',
                'ordre_affichage' => 4,
                'est_actif' => true,
                'est_verrouille' => false,
                'created_at' => $instant,
            ...
            [
                ...
                'libelle_bloc' => "Pieces d'echecs",
                'description_bloc' => 'Le carrousel qui explique les pieces et leurs mouvements.',
                'ordre_affichage' => 5,
                'est_actif' => true,
                'est_verrouille' => false,
                'created_at' => $instant,
            ...
            [
                ...
                'description_bloc' => 'Les cartes resumees et le detail complet des horaires.',
                'ordre_affichage' => 6,
                'est_actif' => true,
                'est_verrouille' => false,
                'created_at' => $instant,
