...
final class ServiceNewsletterMailer
{
    ...
    public function __construct(
        private DepotNewsletterOracle $depotNewsletter,
    ...
    public static function depuisEnvironnement(DepotNewsletterOracle $depotNewsletter): self
    {
